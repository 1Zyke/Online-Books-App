...
namespace OnlineBook.Views
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void LoginBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrMsg.Text = "Invalid password. Please try again.";
            } 
            else if (UnameTb.Value == "Admin@gmail.com" && PasswordTb.Value == "root")
            {
                Response.Redirect("Admin/Books.aspx");
            }
            else
            {
                string Query = "Select * from SelTb Where SelEmail = '{0}' and SelPass = '{1}'";
