...
namespace OnlineBook.Views.Admin
{
    public partial class Seller : System.Web.UI.Page
    {
        ...
        {
            string Query = "Select * from SelTb";
        ...
        protected void SaveBtn_Click(object sender, EventArgs e)
        {
            try
            {
                if (SNameTb.Value == "" || EmailTb.Value == "" || PhoneTb.Value == "" || Password.Value == "")
                {
                ...
                else
                {
                    ...
                    string SAdd = Password.Value;

                    string Query = "insert into SelTb values('{0}','{1}','{2}','{3}')";
        ...
        protected void SellerList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Password.Value = SellerList.SelectedRow?.Cells[5].Text;
        ...
        protected void EditBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string Query = "update SelTb set SelName = '{0}', SelEmail = '{1}', SelPhone = '{2}', SelAddress = '{3}' where SelId = {4}";
        ...
        protected void DeleteBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string Query = "delete from SelTb where SelId = {0}";
